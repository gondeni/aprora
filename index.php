...
<body>
  <main>
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <a href="#!" class="navbar-brand">
              <img src="assets/img/logo/aprora_logo.png" alt="Aprora" style="width:100px;height:50px;">
            </a>
            <!-- End Logo -->
            ...
            <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--lg" id="navBar">
              <ul class="navbar-nav text-uppercase g-pos-rel g-font-weight-600 ml-auto">
                ...
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="src/paginas/quienes_somos.html" class="nav-link g-py-7 g-px-0">Quiénes somos</a>
                </li>
                <!-- End Intro -->

                <!-- Actividades -->
                <li class="hs-has-sub-menu nav-item  g-mx-10--lg g-mx-15--xl" data-animation-in="fadeIn" data-animation-out="fadeOut">
                  <a id="nav-link-actividades" class="nav-link g-py-7 g-px-0" href="#!" aria-haspopup="true" aria-expanded="false" aria-controls="nav-submenu-actividades">Actividades</a>

                  <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-18 g-mt-8--lg--scrolling" id="nav-submenu-actividades" aria-labelledby="nav-link-actividades">
                    <!-- actividades - About -->
                    <li class="dropdown-item hs-has-sub-menu ">
                      <a id="nav-link--actividades--about" class="nav-link" href="#!" aria-haspopup="true" aria-expanded="false" aria-controls="nav-submenu--actividades--about">Formación</a>

                      <!-- Submenu (level 2) -->
                      <ul class="hs-sub-menu list-unstyled u-shadow-v11 g-brd-top g-brd-primary g-brd-top-2 g-min-width-220 g-mt-minus-2" id="nav-submenu--actividades--about" aria-labelledby="nav-link--actividades--about">
                        <li class="dropdown-item ">
                          <a class="nav-link" href="src/paginas/oratoria_profesores.html">Curso: Oratoria para profesores</a>
                        </li>
                        <li class="dropdown-item ">
                          <a class="nav-link" href="src/paginas/oratoria_profesionales.html">Curso: Oratoria para profesionales</a>
                        </li>
                      </ul>
                      <!-- End Submenu (level 2) -->
                    </li>
                    <!-- End Pages - About -->
                    <li class="dropdown-item ">
                      <a class="nav-link" href="src/paginas/concurso_oratoria_primaria.html">Concursos</a>
                    </li>
                  </ul>
                </li>
                <!-- End Pages -->
                ...
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="donde_estamos.html" class="nav-link g-py-7 g-px-0">Dónde estamos</a>
                </li>
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="#!" class="nav-link g-py-7 g-px-0">Asóciate</a>
                </li>
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="#!" class="nav-link g-py-7 g-px-0">Formación bonificable</a>
                </li>
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="#!" class="nav-link g-py-7 g-px-0">Aprora en los medios</a>
                </li>
                <li class="nav-item  g-mx-10--lg g-mx-15--xl">
                  <a href="#!" class="nav-link g-py-7 g-px-0">Contacto</a>
                </li>
              </ul>
            </div>
            <!-- End Navigation -->
            ...
            <div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="#!" target="_blank">Acceso</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <div class="g-overflow-hidden">
      <div id="rev_slider_24_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="website-intro" data-source="gallery" style="background: linear-gradient(to bottom, #0072ab 0%, #00AB39 100%);padding:0px;">
        ...
        <div id="rev_slider_24_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;" data-version="5.4.1">
          <ul>
            ...
            data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 700; color: #ffffff; letter-spacing: -5px;">Haciendo de tus ideas            <br />Algo posible.
          </div>
          ...
          data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;">Aprora
        </div> -->
