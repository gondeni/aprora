    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            <div class="text-center g-mb-50">
                <h2 class="h4">
                    <span class="g-color-primary g-ml-5">APRORA</span>
                    en IV Torneo "ESCLAVAS CHAMBERÍ"
                </h2>
            </div>
            <div id="carousel-08-1" class="js-carousel text-center g-mb-20" data-infinite="true"
                ...
                <div class="js-slide">
                    <a class="js-fancybox d-block g-pos-rel" href="javascript:;" data-fancybox="lightbox-gallery--08-1"
                       data-src="../../assets/img-temp/500x450/img1.jpg" data-caption="Lightbox Gallery"
                ...
                <div class="js-slide">
                    <a class="js-fancybox d-block g-pos-rel" href="javascript:;" data-fancybox="lightbox-gallery--08-1"
                       data-src="../../assets/img-temp/500x450/img2.jpg" data-caption="Lightbox Gallery"
                       data-animate-in="bounceInDown" data-animate-out="bounceOutDown" data-speed="1000"
                       data-overlay-blur-bg="true">
